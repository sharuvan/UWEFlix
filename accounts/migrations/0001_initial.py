    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('student', 'Student'), ('club_manager', 'Club Manager'), ('cinema_manager', 'Cinema Manager'), ('account_manager', 'Account Manager')], max_length=20)),
